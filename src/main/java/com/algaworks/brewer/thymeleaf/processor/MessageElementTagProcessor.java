...
public class MessageElementTagProcessor extends AbstractElementTagProcessor {
    ...
    public MessageElementTagProcessor(TemplateMode templateMode, String dialectPrefix, String elementName, boolean prefixElementName, String attributeName, boolean prefixAttributeName, int precedence) {
        super(TemplateMode.HTML, dialectPrefix, NOME_TAG, prefixElementName, attributeName, prefixAttributeName, PRECEDENCIA);
    }
